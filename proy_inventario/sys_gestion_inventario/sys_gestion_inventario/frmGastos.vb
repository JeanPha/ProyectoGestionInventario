...
Public Class frmGastos
    Private Sub frmGastos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ConsultaSqlIngresos.ActualizarSumaIngresos()
        lbIngresos.Text = ConsultaSqlIngresos.sumaIngresos.ToString("C")

        ConsultaSqlIngresos.ActualizarSumaGastos()
        lbGastos.Text = ConsultaSqlIngresos.sumaGastos.ToString("C")

        ConsultaSqlIngresos.ActualizarDiferencia()
        lbSaldos.Text = ConsultaSqlIngresos.diferencia.ToString("C")
    End Sub
    ...
    Private Sub btnMetodo_Click(sender As Object, e As EventArgs)
        flag_where = 1
    ...
    Private Sub btnCategoria_Click_1(sender As Object, e As EventArgs) Handles btnCategoria.Click
        flag_where = 1
    ...
    Private Sub btnMetodo_Click_1(sender As Object, e As EventArgs) Handles btnMetodo.Click
        flag_where = 1
    ...
    Private Sub btnTipo_Click_1(sender As Object, e As EventArgs) Handles btnTipo.Click
        flag_where = 1
