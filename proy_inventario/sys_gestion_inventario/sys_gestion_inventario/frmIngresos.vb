...
Public Class frmIngresos
    ...
    Private Sub btnMetodo_Click(sender As Object, e As EventArgs)
        ...
        frm.Owner = Me ' Establecer el formulario principal como propietario
        frm.StartPosition = FormStartPosition.Manual
        frm.Location = New Point(-7, 49)
        frm.ShowDialog()

        'Actualiza los campos en frmIngresos cuando frmMetodosTransaccion se cierra 
        txtIdMetodo.Text = frm.IdMetodoSeleccionado
        txtMetodo.Text = frm.MetodoSeleccionado
